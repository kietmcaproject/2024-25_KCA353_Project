    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        <div className="text-center">
          <UserCircle className="mx-auto h-12 w-12 text-orange-500" />
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="appearance-none block w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
