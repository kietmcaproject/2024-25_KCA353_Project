...
import Star from "@/public/assests/landingPage/emojistar 1.png";
import Helix from "@/public/assests/landingPage/helix2 1.png";
  ...
  return (
    ...
    >
      <div className="max-w-[570px] flex flex-col items-center relative">
        ...
        Experience intuitive project management with peer collaboration tools.
        </div>

        <div className="flex items-center gap-4 mt-4 text-lg">
          <Button text="Get for free" color="black"/>
