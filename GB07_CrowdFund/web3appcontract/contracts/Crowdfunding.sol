...
contract Crowdfunding {
    ...
    struct Backer {
        ...
        mapping(uint256 => uint256) contributionsPerTier;
    ...
    function fund(uint256 _tierIndex) public payable campaignOpen notPaused {
        ...
        backers[msg.sender].contributionsPerTier[_tierIndex] += msg.value;
    ...
    function getContributionForTier(address _backer, uint256 _tierIndex) public view returns (uint256) {
        return backers[_backer].contributionsPerTier[_tierIndex];
    }
}
