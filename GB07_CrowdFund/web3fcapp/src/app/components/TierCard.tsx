...
export const TierCard: React.FC<TierCardProps> = ({ tier, index, contract, isEditing }) => {
    // const { data: investors , isPending } = useReadContract({
    //     contract,
    ...
    //     const { data : contribution, isPending } = useReadContract({
    //         contract,
    //         method: "function getContributionForTier(address _backer, uint256 _tierIndex) view returns (uint256)",
    //         params: [investor, BigInt(index)]
    //       });
    //     array.push({
