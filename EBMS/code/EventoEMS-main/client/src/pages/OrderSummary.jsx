        ...
        <div className='flex flex-col'>
            <div className= 'inline-flex gap-5 mt-8'> 
                <div className="p-4 ml-12 bg-gray-100 w-3/4 mb-12">
                    <h2 className="text-left font-bold"> Terms & Conditions </h2> <br/>
                    <div>
                ...
                <div className="w-1/4 pl-4 h-1/4 mr-12 bg-blue-100">
                    <h2 className="mt-4 font-bold"> Booking Summary </h2>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <div className='px-2 text-sm'> I have verified the Event name, date and time before proceeding to payment. I accept terms and conditions. </div>
                        </div>
